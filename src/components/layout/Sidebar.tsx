  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 md:flex">
      ...
      {streak.currentStreak > 0 && (
        <div className="mx-3 mb-4 flex items-center gap-2 rounded-xl bg-orange-50 px-3 py-2.5 text-sm font-medium text-orange-700 dark:bg-orange-950/40 dark:text-orange-300">
