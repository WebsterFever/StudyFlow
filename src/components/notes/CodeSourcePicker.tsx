...
interface CodeSourcePickerProps {
  ...
  /** Project Folder upload only makes sense for programming/technology goals — hidden for other learning types. */
  allowProjectUpload: boolean
}

export function CodeSourcePicker({ onSelect, allowProjectUpload }: CodeSourcePickerProps) {
  return (
    <div>
